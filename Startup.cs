...
using BlackEagleBot.Adapters;
using BlackEagleBot.Authentication;
using BlackEagleBot.Bots;
using BlackEagleBot.Dialogs;
using BlackEagleBot.Services;
using BlackEagleBot.TokenExchange;

namespace BlackEagleBot
{
